...
#define	MCACHE	(MyLong)(11-(sizeof(float)/8))	// fft's with M bigger than this bust primary cache
...
float w1r = (float)(1.0/MYROOT2); /* cos(pi/4)	*/			//**CAST**
float f0r, f0i, f1r, f1i, f2r, f2i, f3r, f3i;
float f4r, f4i, f5r, f5i, f6r, f6i, f7r, f7i;
float t1r, t1i;
const float Two = 2.0;
...
const MyULong Nrems2 = POW2((M+3)/2);
const MyULong Nroot_1_ColInc = POW2(M)-Nrems2;
const MyULong Nroot_1 = POW2(M/2-1)-1;
const MyULong ColstartShift = (M+1)/2 +1;
posA = POW2(M);		// 1/2 of POW2(M) complexes
posAi = posA + 1;
posB = posA + 2;
posBi = posB + 1;
...
/***   RADIX 16 rfft	***/
float w0r = (float)(1.0/MYROOT2); /* cos(pi/4)	*/			//**CAST**
float w1r = (float)MYCOSPID8; /* cos(pi/8)	*/				//**CAST**
float w1i = (float)MYSINPID8; /* sin(pi/8)	*/				//**CAST**
float f0r, f0i, f1r, f1i, f2r, f2i, f3r, f3i;
float f4r, f4i, f5r, f5i, f6r, f6i, f7r, f7i;
float t0r, t0i, t1r, t1i;
const float Two = 2.0;
